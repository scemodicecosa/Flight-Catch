...
public class Utils {
	...
	public static String createGoogleURL(String departure, String arrive, String month){
		String s = "https://www.google.it/flights/#search;f="+Destinations.getGoogleMin(departure)+
